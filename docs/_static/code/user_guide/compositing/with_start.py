...
# We want to stop clip1 after 6s
clip1 = clip1.with_end(6)

# We want to play clip2 after 5s
clip2 = clip2.with_start(5)

# We want to play clip3 at the end of clip2, and so for 3 seconds only
clip3 = clip3.with_start(clip2.end).with_duration(3) # Some times its more practical to modify the duration of a clip instead of his end
