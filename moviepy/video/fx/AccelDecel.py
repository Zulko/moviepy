...
class AccelDecel(Effect):
    ...
    def _f_accel_decel(self, t, old_duration, new_duration, abruptness=1.0, soonness=1.0):
        a = 1.0 + abruptness
    ...
    def apply(self, clip):
        ...
        return clip.time_transform(
            lambda t: self._f_accel_decel(t=t, old_duration=clip.duration , new_duration=self.new_duration, abruptness=self.abruptness, soonness=self.soonness)
