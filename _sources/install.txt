...
MoviePy is a very small program but it relies on many existing Python libraries that you will need to install first:
...
And it needs some external software:
